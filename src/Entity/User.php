...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * Fait en sort que le nom soit bien renseigné 
     * 
    ...
    /**
     * @ORM\Column(type="string", length=255)
     *@Assert\Email(message="Veuillez rensigner un email valide")
     */
    private $email;
    ...
    // rajout d'un champ qui permet de faire fonctionner la validation du mdp dans mon formulaire
    /**
     * 
     ...
     * @ORM\PreUpdate
     */
    public function innitializeSlug()
    {
        if(empty($this->slug)){
            $slugify = new Slugify();
    ...
    public function getRoles()
    {
        ...
        // retourne la liste du role en chaine de caratère
