...
class Ad
{
     ...
     * l'instruction ci-dessous valide le sous formulaire des ajouts de photos
     * @Assert\Valid()
     */
    private $images;
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach($this->bookings as $booking){
            // calculer les jours qui se trouvent entre la date d'arriver et de départ (seconde)
            $resultat = range(
